 ...
 */
  ...
  martone.SetOsc(1,   1,  .5,      1,        220,  10000,   2.33,      1);    
  martone.SetOsc(1,   2,  0,       5,        440,  10000,   2.33,      1);       
  martone.SetOsc(1,   3,  0,       9,        880,  10000,   2.33,      1);        
  martone.SetOsc(1,   4,  0,       3,        990,  10000,   2.33,      1);   

  //String 2. string, osc, volume, waveform, freq, freqCut, filtSlope. filtRes                  
  martone.SetOsc(2,   1,  .5,      2,        220,  10000,   2.33,      1);    
  martone.SetOsc(2,   2,  .6,      6,        440,  10000,   2.33,      1);      
  martone.SetOsc(2,   3,  .7,      0,        880,  10000,   2.33,      1);       
  martone.SetOsc(2,   4,  .8,     4,       1000,  10000,   2.33,      1);     

  //String 3. string, osc, volume, waveform, freq, freqCut, filtSlope, filtRes                  
  martone.SetOsc(3,   1,  .9,      3,      220,  10000,   2.33,      1);       
  martone.SetOsc(3,   2,  .11,      7,      440,  10000,   2.33,      1);        
  martone.SetOsc(3,   3,  .22,     1,      880,  10000,   2.33,      1);        
  martone.SetOsc(3,   4,  .33,      5,     1660,  10000,   2.33,      1);     

  //String 4. string, osc, volume, waveform, freq, freqCut, filtSlope, filtRes                  
  martone.SetOsc(4,   1,  .44,      4,      220,  10000,   2.33,      1);         
  martone.SetOsc(4,   2,  .55,      8,      440,  10000,   2.33,      1);          
  martone.SetOsc(4,   3,  .66,     2,      880,  10000,   2.33,      1);      
  martone.SetOsc(4,   4,  .69,      7,     1660,  10000,   2.33,      1);                       
