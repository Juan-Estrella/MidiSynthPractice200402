...
//******************************
Martone::Martone(int octave, int startNote, int scale, float volume, float filtFreqCutoff, float filtRes, float attack, float decay, float sustain, float release, int lfoShape, int lfoMode, float lfoSpeed, float lfoDepth, float lfoPitch, float lfo, float lfoRange, float filtPercent, bool interpolate, bool poly, int temperament, int electrode3D)
{    
    m_octave = octave;
...
// //Public Functions
// //=================
// void Martone::Initialize(Martone *pStr[], Martone *pOsc[])
// {
...
// }
// //*************************************************************
// void Martone::Update(Martone *pStr[], Martone *pOsc[])
// {
...
// }
// //*********************************************************
// void Martone::SetOsc(float m_volume, int m_waveform, int m_osc, Martone *pStr[], Martone *pOsc[])
// {
...
// }
// //*********************************************************
// void Martone::UpdateSettings(int pIndex, Martone *pStr[], int m_str, int m_osc, Martone *pOsc[])
// {
//     float xSpeed;
//     switch (pIndex)
//     {
...
//         SetOsc(pStr[m_str]->m_oscVol[m_osc], pStr[m_str]->m_oscWave[m_osc], m_osc, pStr, pOsc);
//         break;
